...
class SpecialTopicForm(TopicForm):
    ...
    # def add_title_speical_topic_prefix(self):
    #     new_title = "Special Topic " + self.title
    #     return new_title
    
    # def add_content_speical_topic_prefix(self):
    #     new_content = "Special Topic " + self.content
    #     return new_content
    #pass
